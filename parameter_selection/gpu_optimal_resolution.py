...
def find_optimal_cell_resolution_linux(
    ...
    if verbose:
        print(f"Using GPU/Linux version of optimal resolution finder for {modality_upper}")
...
def _write_final_summary_linux(
    ...
    with open(summary_path, "w") as f:
        f.write(f"{modality} RESOLUTION OPTIMIZATION FINAL SUMMARY (GPU/Linux Version)\n")
        f.write("=" * 70 + "\n\n")
