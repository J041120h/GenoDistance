#!/usr/bin/env python3
"""
Multi-omics Optimal Resolution Finding Module - CPU Version
...
- Uses calculate_multiomics_sample_embedding for integrated pseudobulk and DR
...
- Optional corrected p-value computation for multiple testing correction

Author: Adapted for CPU usage
"""
...
# =============================================================================
# MAIN RESOLUTION OPTIMIZATION FUNCTION - CPU VERSION
# =============================================================================

def find_optimal_cell_resolution_multiomics(
    ...
    """
    Find optimal clustering resolution for integrated RNA+ATAC data - CPU version.
    ...
    Uses calculate_multiomics_sample_embedding for integrated pseudobulk and DR computation.
    ...
    print("\n" + "=" * 80)
    print("MULTI-OMICS RESOLUTION OPTIMIZATION (CPU)")
    print("=" * 80)
    ...
    if verbose:
        ...
        print(f"  Cell type method: cell_types_multiomics (CPU)")
        print(f"  Sample embedding: calculate_multiomics_sample_embedding (CPU)")
    ...
    def process_resolution(resolution: float, search_pass: str) -> Tuple[dict, dict]:
        ...
        try:
            ...
            # Step 1: Clustering using cell_types_multiomics (CPU version)
            ...
            # Step 2: Sample embedding using calculate_multiomics_sample_embedding (CPU)
