...
def validate_multiple_methods(sample_distance_path: str,
    ...
    total_possible = len(methods) * 2  # 2 DR types per method
...
def create_comprehensive_plots(df: pd.DataFrame, output_dir: str):
    ...
    print("     Panel 2: Effect size heatmap...")
    ax2 = axes[0, 1]
    ...
    print("     Panel 3: Method comparison bar plot...")
    ax3 = axes[1, 0]
