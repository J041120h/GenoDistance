...
if __name__ == "__main__":
    csv_path = '/dcs07/hongkai/data/harry/result/Benchmark_heart_rna/benchmark_summary_heart_rna.csv'
    output_dir = '/dcs07/hongkai/data/harry/result/Benchmark_heart_rna'
