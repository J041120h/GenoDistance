...
def rna_wrapper(
    ...
    """
    RNA-seq analysis wrapper function that processes single-cell RNA data.
    ...
    rna_count_data_path : str
        Path to the input RNA h5ad file
    rna_output_dir : str
    ...
    exclude_genes : list, optional
        Genes to exclude
    num_cell_hvgs : int
        Number of highly variable genes for cell embedding
    cell_embedding_num_pcs : int
        Number of PCs for cell embedding
    ...
    sample_hvg_number : int
        Number of HVGs for sample embedding
    ...
    if sample_cluster:
        ...
        status_flags["rna"]["sample_cluster"] = True
    ...
    if proportion_test:
        ...
        try:
            ...
            status_flags["rna"]["proportion_test"] = True
