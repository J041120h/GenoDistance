...
class BenchmarkWrapper:
    ...
    def run_pseudotime_embeddings_custom(
        ...
        **kwargs
        ...
        """
        Simple version that expects pseudotime CSV with columns:
            sample,pseudotime
        and uses 'pseudotime' directly, aligned by sample ID.
        """
...
def run_benchmarks(
    ...
    **kwargs,
    ...
    benchmarks_to_run : list of str, optional
        ...
        Options: ['embedding_visualization', 'trajectory_anova', 'batch_removal', 
    ...
    **kwargs : dict
    ...
    try:
        ...
        if benchmarks_to_run:
            all_benchmarks = ["embedding_visualization", "trajectory_anova", "batch_removal", 
                            "ari_clustering", "trajectory_analysis", "pseudotime_embeddings_custom"]
