...
if __name__ == "__main__":
    add_raw_counts_layer_by_obs_names(
        preprocessed_h5ad_path= '/dcs07/hongkai/data/harry/result/Benchmark_eye_rna/retina/rna/preprocess/adata_cell.h5ad',
        raw_h5ad_path= '/dcs07/hongkai/data/harry/result/multi_omics_eye/data/rna/retina.h5ad',
