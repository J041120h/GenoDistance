...
Three-AnnData design (see SampleDisco_Draft-4.pdf):
  ...
  ① ``build_embedding_union``
        ...
        (X_glue, plus Z_comp / Z_rmd when present from the 2-run scGLUE
...
def build_embedding_union(
    ...
    *,
    ...
    obsm_keys_to_carry: Sequence[str] = ("X_glue", "Z_comp", "Z_clust", "Z_rmd",
                                        "Z_cmd", "X_umap"),
    verbose: bool = True,
) -> ad.AnnData:
    ...
    Z_comp / Z_rmd merged in via the 2-run scGLUE flow), concatenates cells
...
def preprocess_rna_for_downstream(
    ...
    *,
    ...
    from the union after Leiden runs on Z_comp.
    """
