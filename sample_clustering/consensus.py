...
def buildConsensus(sample_distance_path, generalFolder, methods=None, run_methods=True):
    """
    ...
    consensusFolder = os.path.join(resultFolder, "Combined")
    ...
    if run_methods:
        for method in methods:
            if method in method_functions:
                ...
                method_function = method_functions[method]
                method_function(sample_distance_path, os.path.join(generalFolder, method))
            else:
    ...
    for method in methods:
        methodFolder = os.path.join(resultFolder, method)
    ...
    outputFileNex = os.path.join(consensusFolder, "Consensus.nex")
    outputFileNwk = os.path.join(consensusFolder, "Consensus.nwk")
    outputImagePath = os.path.join(consensusFolder, "Consensus.png")
